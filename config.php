<?php
	...
	define('APP_ID',"edd56835093cf7460190a3ef3835feee");
	...
	define('META_AUTHOR','Suhendar Aryadi - Layung');
	define('META_DESCRIPTION','Suhendar Aryadi - Layung');
	define('META_KEYWORDS','siap');
	...
	define('DB_USERNAME','u5645587_siapsekolah');
	define('DB_PASSWORD','Bismillah1');
	define('DB_NAME','u5645587_siapsekolah');
