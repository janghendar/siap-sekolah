...
class UserController extends SecureController{
	...
	function add(){
		if(is_post_request()){
			...
			$modeldata['pass'] = password_hash($password_text , PASSWORD_DEFAULT);
			$db = $this->GetModel();
	...
	function edit($rec_id=null){
		...
		if(is_post_request()){
			...
			$fields=array('id','username','nama','role','foto');
			$db->where('id' , $rec_id);
