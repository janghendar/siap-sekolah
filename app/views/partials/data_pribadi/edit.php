    <template id="data_pribadiEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Data Pribadi</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'data_pribadi/edit/' + data.id" method="post">
    ...
    <script>
	var Data_PribadiEditComponent = Vue.component('data_pribadiEdit', {
		template : '#data_pribadiEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'data_pribadiedit',
			},
			apipath : {
				type : String,
				default : 'data_pribadi/edit',
			},
		},
		data: function() {
			return {
				data : { foto: '',nama: '',nik: '',nip: '',nuptk: '',nrg: '',tempat_lahir: '',tgl_lahir: '',jenis_kelamin: '',status_kawin: '',agama: '',status_pegawai: '',tmt: '',kedudukan_pegawai: '',pendidikan_akhir: '',tahun_pendidikan: '',masa_kerja: '',golongan: '',gaji_pokok: '',no_karpeg: '',no_askes: '',npwp: '',gol_darah: '',alamat_ktp: '',alamat_domisili: '', },
